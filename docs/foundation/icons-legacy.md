...
<i class="alert-icon-warning alert-icon"></i> <b>Notice:</b>  These legacy SVG icons will be deprecated in version 2.0 of the USPTO UI Design Library -  We recommend updating your project to <a href="https://fontawesome.com/" target="_blank">Font Awesome 5</a> with SVG support.
</div>
{:/nomarkdown}
...
<div class="row pl-icon-list">
    ...
    <div class="col-lg-4 col-md-6 col-sm-6"><i class="icon-oc oc-collapse-set"></i> oc-collapse-set</div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6"><i class="icon-oc oc-pdf-annotate-esignature"></i> oc-pdf-annotate-esignature</div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6"><i class="icon-oc oc-wordedit-icon"></i> oc-wordedit-icon</div>
    <div class="col-lg-4 col-md-6 col-sm-6"><i class="icon-oc oc-word-icon"></i> oc-word-icon</div>
    <div class="col-lg-4 col-md-6 col-sm-6"><i class="icon-oc oc-zoom-handle-icon"></i> oc-zoom-handle-icon</div>
...
These icons were created for the Official Correspondence application.
...
### Iconathon - Intellectual Property Symbols
